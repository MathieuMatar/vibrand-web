...
class ClientController {
    static async getClients(req, res) {
        ...
        console.log("request for all clients,", "time", Date.now());
        try {
    ...
    static async getClient(req, res) {
        ...
        try {
            const { id } = req.params;
            console.log("request for client,", id , "time", Date.now());
    ...
    static async createClient(req, res) {
        try {
            ...
            console.log("request to add client", req.body, ), "time", Date.now()
